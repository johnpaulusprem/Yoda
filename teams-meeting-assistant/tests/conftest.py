...
- mock_acs_client: AsyncMock for ACSCallService
...
_TEST_ENV = {
    ...
    "ACS_CONNECTION_STRING": "endpoint=https://test-acs.communication.azure.com/;accesskey=dGVzdA==",
...
async def test_client(
    ...
    with patch.dict("os.environ", _TEST_ENV, clear=False):
        ...
        test_app.include_router(
            acs_callbacks_router, prefix="/callbacks", tags=["acs"]
        )
        test_app.include_router(
