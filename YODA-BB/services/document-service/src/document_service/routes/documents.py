...
async def search_documents(
    ...
    from document_service.dependencies import get_retriever
...
async def classify_text(
    ...
    """
    from document_service.dependencies import get_document_classifier
...
async def _process_document_background(document_id: UUID) -> None:
    ...
    from document_service.dependencies import (
