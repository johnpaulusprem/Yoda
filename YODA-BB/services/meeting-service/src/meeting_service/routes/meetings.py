...
from meeting_service.utils.azure_ad_auth import get_current_user
...
async def check_browser_bot() -> dict:
    ...
    from meeting_service.services.bot_commander import get_shared_bot_commander, BotCommander
...
async def join_meeting(
    ...
    try:
        ...
        raise HTTPException(
            status_code=502,
            detail="Failed to communicate with meeting bot",
        ) from exc
    finally:
        if owns_bot:
            await bot.close()
