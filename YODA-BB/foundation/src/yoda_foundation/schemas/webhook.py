...
# Monolith-compatible alias: the monolith used ``GraphChangeNotification``
# while the compiled foundation used ``GraphNotification``.
GraphChangeNotification = GraphNotification
