...
class YodaBaseException(Exception):
    """
    ...
    def with_details(self, **kwargs: Any) -> YodaBaseException:
...
def create_exception(
    exception_class: type[YodaBaseException],
    message: str,
    **kwargs: Any,
) -> YodaBaseException:
...
# Alias so submodules ported from dhurunthur (agentic_ai_library) can
# import ``AgenticBaseException`` without modification.
AgenticBaseException = YodaBaseException
